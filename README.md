...
**Figure 1** — Incident Response Life Cycle diagram (module introduction, 0% progress)
![Figure 1](images/figure-01.png)

**Figure 2** — Wazuh Alerts list: LSASS access alert on host SCWIN01 (Cyber Kill Chain section)
![Figure 2](images/figure-02.png)

**Figure 3** — Alert detail: LSASS process accessed by mimikatz.exe, MITRE T1003.001 tagged
![Figure 3](images/figure-03.png)

**Figure 4** — Alert detail: "[InsightNexus] Hacker tool Mimikatz was detected" — Critical severity, T1003/T1003.001 tags
![Figure 4](images/figure-04.png)

**Figure 5** — Alerts list showing the Mimikatz alert alongside the ManageEngine admin login alert (Detection & Analysis Stage)
![Figure 5](images/figure-05.png)

**Figure 6** — Alert detail: suspicious process loaded VaultCli.dll, full file hashes shown (Containment, Eradication & Recovery)
![Figure 6](images/figure-06.png)

**Figure 7** — Terminal: `grep` for credential-dumping indicators; confirms parent process `firefox.exe` (Skills Assessment Q1)
![Figure 7](images/figure-07.png)

**Figure 8** — Terminal: `grep` for `imagePath`; confirms PSEXESVC persistence mechanism on host DB01 (Skills Assessment Q2)
![Figure 8](images/figure-08.png)

**Figure 9** — Terminal: exfiltration event showing outbound POST of diagnostics_data.zip to 93.184.216.34 (Skills Assessment Q3)
![Figure 9](images/figure-09.png)

**Figure 10** — Firefox JSON viewer: searching wazuh_export.json for "projects" (file share lateral movement)
![Figure 10](images/figure-10.png)

**Figure 11** — Terminal: `grep` for host "fs01" to confirm agent FS01 (172.16.10.20)
![Figure 11](images/figure-11.png)

**Figure 12** — Terminal: `grep` for "projects"; confirms SMB connection by user svc_admin
![Figure 12](images/figure-12.png)

**Figure 13** — Terminal: cross-checking an additional FS01 log entry/timestamp
![Figure 13](images/figure-13.png)

**Figure 14** — Terminal: final confirmation pass on FS01 agent data before submitting svc_admin as the answer
![Figure 14](images/figure-14.png)

**Figure 15** — Alert detail: "[InsightNexus] Admin Login via ManageEngine Web Console" — external IP 103.112.60.117, T1078.001 tagged
![Figure 15](images/figure-15.png)

**Figure 16** — VirusTotal: relations lookup for IP 203.0.113.18 (communicating/referring files)
![Figure 16](images/figure-16.png)

**Figure 17** — Same ManageEngine alert, comments showing related connection to 198.51.100.24:443
![Figure 17](images/figure-17.png)

**Figure 18** — VirusTotal: WHOIS lookup for 198.51.100.24, confirming an IANA-reserved (RFC 5737) documentation address
![Figure 18](images/figure-18.png)

**Figure 19** — Skills Assessment Question 3: MITRE technique for C2 tool transfer — answered T1105
![Figure 19](images/figure-19.png)

**Figure 20** — Terminal: `grep` for "powershell" alert description ("suspicious download and write to AppData")
![Figure 20](images/figure-20.png)

**Figure 21** — Terminal: full Sysmon event showing mshta.exe spawning powershell.exe, downloading payload to AppData
![Figure 21](images/figure-21.png)

**Figure 22** — Terminal: `jq` troubleshooting and successful extraction of the powershell.exe path / SRV-MANAGE01 agent
![Figure 22](images/figure-22.png)

**Figure 23** — Terminal: `jq` regex match locating the Base64 `-EncodedCommand` blob and its SHA256 hash
![Figure 23](images/figure-23.png)

**Figure 24** — CyberChef: decoding the Base64 command, revealing the callout to 198.51.100.24
![Figure 24](images/figure-24.png)

**Figure 25** — Terminal: `jq` extraction confirming CORP\svc-update as the user who ran the PowerShell command (Skills Assessment Q6)
